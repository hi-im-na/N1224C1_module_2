...
public class InputCommonV3 implements AutoCloseable {
    private static final InputCommonV3 INSTANCE = new InputCommonV3();
    private final Scanner sc = new Scanner(System.in);

    private InputCommonV3() {
    }

    public static InputCommonV3 getInstance() {
        return INSTANCE;
    }
